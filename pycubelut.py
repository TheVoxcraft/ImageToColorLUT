...
def process_image(image_path, output_path, thumb, lut, log, output_name, quality=95, desat=False):
    ...
    if image_ext.lower() == '.tif' or image_ext.lower() == '.tiff':
        ...
        if thumb != 0:
            ...
            im = im.resize(thumb, Image.BICUBIC)
        ...
        new_im.save(os.path.join(output_dir, output_name), quality=quality)
